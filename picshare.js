		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$src('https://programming-elm.com/' + filename)
						]),
					_List_Nil),
					A2(
					elm$html$Html$div,
...
var author$project$Picshare$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A2(author$project$Picshare$viewPhoto, '1.jpg', 'Surfing'),
					A2(author$project$Picshare$viewPhoto, '2.jpg', 'The Fox'),
					A2(author$project$Picshare$viewPhoto, '3.jpg', 'Evening')
				]))
		]));
