...
var author$project$Picshare$initialModel = {caption: 'Nature', liked: false, url: 'https://placeimg.com/640/480/nature'};
...
var author$project$Picshare$viewPhoto = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Picshare$viewPhoto(model)
					]))
			]));
};
